...
class JavaProgram(core.program.program_base.ProgramBase):
    def compile(self):
        ...
        return limited_subprocess(compile_command, stdin=None, time_limit=20, memory_limit=1024*10)
    ...
    def execute(self, stdin: str, args: list[str] = None, time_limit: int = 2, memory_limit: int = 256):
        ...
        return limited_subprocess(execute_command, stdin=stdin, time_limit=time_limit, memory_limit=1024*10)